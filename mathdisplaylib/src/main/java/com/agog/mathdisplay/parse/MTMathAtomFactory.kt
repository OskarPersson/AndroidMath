...
open class MTMathAtomFactory {
    ...
    private val supportedLatexSymbols: HashMap<String, MTMathAtom> = hashMapOf(
            ...
            "aa" to MTMathAtom(MTMathAtomType.KMTMathAtomOrdinary, "\u00E5"),
            "ae" to MTMathAtom(MTMathAtomType.KMTMathAtomOrdinary, "\u00E6"),
            "o"  to MTMathAtom(MTMathAtomType.KMTMathAtomOrdinary, "\u00F8"),
            "oe" to MTMathAtom(MTMathAtomType.KMTMathAtomOrdinary, "\u0153"),
            "ss" to MTMathAtom(MTMathAtomType.KMTMathAtomOrdinary, "\u00DF"),
            "O"  to MTMathAtom(MTMathAtomType.KMTMathAtomOrdinary, "\u00DB"),
            "AE" to MTMathAtom(MTMathAtomType.KMTMathAtomOrdinary, "\u00C6"),
            "OE" to MTMathAtom(MTMathAtomType.KMTMathAtomOrdinary, "\u0152"),
            "|" to MTMathAtom(MTMathAtomType.KMTMathAtomOrdinary, "\u2016"),
